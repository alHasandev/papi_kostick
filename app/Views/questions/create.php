...
<section class="row">
  <div class="col-md-6 mx-auto">
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="/soal/save" method="POST">
        <div class="card-body">
          <div class="form-group">
            <label for="a_code">Pilihan A</label>
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="a_code_label"><?= $aspects[0]['code'] ?></span>
              </div>
              <select name="a_code" id="a_code" class="form-control" onchange="setCodeLabel(this)">
                <?php foreach ($aspects as $data) : ?>
                  <option value="<?= $data['code'] ?>"><?= $data['description'] ?> (<?= $data['code'] ?>)</option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="input-group mb-3">
              ...
              <input type="text" name="a_declaration" class="form-control" placeholder="Deklarasi...">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="b_code_label"><?= $aspects[0]['code'] ?></span>
              </div>
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" name="b_declaration" class="form-control" placeholder="Deklarasi...">
            </div>
          </div>
        </div>
        <!-- /.card-body -->
